...
goto r
protoc -I . -I /Users/cola/GoWorks/src -I /Users/cola/GoWorks/src/github.com/envoyproxy/protoc-gen-validate --go_out=":../generated" --validate_out="lang=go:../generated" example.proto
:r
