...
// Validate checks the field values on CSCreatePlayer with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *CSCreatePlayer) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CSCreatePlayer with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in CSCreatePlayerMultiError,
// or nil if none found.
func (m *CSCreatePlayer) ValidateAll() error {
	return m.validate(true)
}

func (m *CSCreatePlayer) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CSCreatePlayerMultiError(errors)
	}

	return nil
}

// CSCreatePlayerMultiError is an error wrapping multiple validation errors
// returned by CSCreatePlayer.ValidateAll() if the designated constraints
// aren't met.
type CSCreatePlayerMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CSCreatePlayerMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CSCreatePlayerMultiError) AllErrors() []error { return m }

// CSCreatePlayerValidationError is the validation error returned by
// CSCreatePlayer.Validate if the designated constraints aren't met.
type CSCreatePlayerValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CSCreatePlayerValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CSCreatePlayerValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CSCreatePlayerValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CSCreatePlayerValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CSCreatePlayerValidationError) ErrorName() string { return "CSCreatePlayerValidationError" }

// Error satisfies the builtin error interface
func (e CSCreatePlayerValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = CSCreatePlayerValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CSCreatePlayerValidationError{}

// Validate checks the field values on SCCreatePlayer with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *SCCreatePlayer) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SCCreatePlayer with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in SCCreatePlayerMultiError,
// or nil if none found.
func (m *SCCreatePlayer) ValidateAll() error {
	return m.validate(true)
}

func (m *SCCreatePlayer) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SCCreatePlayerMultiError(errors)
	}

	return nil
}

// SCCreatePlayerMultiError is an error wrapping multiple validation errors
// returned by SCCreatePlayer.ValidateAll() if the designated constraints
// aren't met.
type SCCreatePlayerMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SCCreatePlayerMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SCCreatePlayerMultiError) AllErrors() []error { return m }

// SCCreatePlayerValidationError is the validation error returned by
// SCCreatePlayer.Validate if the designated constraints aren't met.
type SCCreatePlayerValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SCCreatePlayerValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SCCreatePlayerValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SCCreatePlayerValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SCCreatePlayerValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SCCreatePlayerValidationError) ErrorName() string { return "SCCreatePlayerValidationError" }

// Error satisfies the builtin error interface
func (e SCCreatePlayerValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = SCCreatePlayerValidationError{}
